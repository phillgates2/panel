...
from models_extended import (
    ServerTemplate, UserGroup, UserActivity, Notification
)
...
def create_user_groups():
    ...
    groups = [
        {'name': 'Moderators', 'description': 'Server moderators', 'permissions': '["kick", "ban", "mute"]'},
        {'name': 'Admins', 'description': 'Server administrators', 'permissions': '["all"]'},
        {'name': 'VIP', 'description': 'VIP players', 'permissions': '["reserved_slot"]'},
    ]
...
def create_notifications():
    ...
    messages = [
        ...
        ('Server Ready', 'Your server is now online and ready to accept players.', 'success'),
...
def clear_all_data():
    ...
    for model in [UserActivity, Notification, ServerTemplate, Server, AuditLog, UserGroup, User]:
