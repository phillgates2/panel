...
class AIModelTrainer:
    ...
    async def create_fine_tuning_job(
        self, base_model: str, training_data: List[Dict], parameters: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"error": str(e), "message": "Failed to create training job"}
    ...
    async def create_dataset_from_history(
        self, user_id: int, data_type: str = "conversations"
    ) -> List[Dict]:
        ...
        try:
            ...
            if data_type == "conversations":
                ...
                conversations = [
                    {
                        "input": "How do I install mods?",
                        "output": "To install mods, first download them from a trusted source...",
                    },
                    {
                        "input": "Server keeps crashing",
                        "output": "Server crashes can be caused by several issues...",
                    },
                    {
                        "input": "What's the best graphics settings?",
                        "output": "Optimal graphics settings depend on your hardware...",
                    },
                ]
    ...
    async def evaluate_model_performance(
        self, model_id: str, test_data: List[Dict]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"error": str(e), "accuracy": 0.0, "total_samples": 0}
